...
const CarCard = ({car}) => {
  ...
  return (
    ...
    className='group rouded-xl overflow-hidden shadow-lg hover:-translate-y-1 translate-all duration-500 cursor-pointer'>
      ...
      <div className='relative h-48 overflow-hidden'>
        ...
        {car.isAvailable && <p className='absolute top-4 left-4 bg-primary/90 text-white text-x5 px-2.5 py-1 rounded-full'>Available Now</p>}
