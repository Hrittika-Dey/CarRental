...
const ManageCars = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Cars" subTitle="View and manage your listed cars, update their details, or remove them from the booking platform."/>
            ...
            {cars.map((car,index)=>(
              <tr key={index} className='border-t border-borderColor'>
                ...
                <td className='p-3 max-md:hidden'>
                  <span className={`px-3 py-1 rounded-full text-xs ${car.isAvailable ? 'bg-green-100 text-green500' : 'bg-red-100 text-red-500'}`}>
